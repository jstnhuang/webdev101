...
function initWhiteboardBindings(id) {
    ...
    $(idHash + ' input[name="downloadButton"]').click(function() {
...
function handleTabClick(e) {
    ...
    var downloadButton = $('#' + id).find('input[name="downloadButton"]');
    var downloadButtonText = $(downloadButton).val();
    downloadButtonText = downloadButtonText.replace(
        $(activeSelector).html(), $(clickedSelector).html());
...
function handleDownloadButtonClick(id) {
    var idHash = '#' + id;
    var type = $(idHash + ' .active').html();
    var contents = $(idHash + ' .codeArea').val();
    $(idHash + ' input[name="type"]').val(type);
    $(idHash + ' input[name="contents"]').val(contents);
}
